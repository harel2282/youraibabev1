  ...
  try {
    ...
    if (body.mode === "voice_opener") {
      ...
      const sys =
        ...
        ((profile && profile.lang === "he") ? (" Write the line in natural, casual, fluent Israeli Hebrew (עברית) — not English. Write every Hebrew word fully vocalized with niqqud (vowel diacritics), because it will be read aloud by a speech engine." + ((profile.userGender === "female") ? " Address her in Hebrew feminine form (את)." : " Address him in Hebrew masculine form (אתה).")) : "");
      const ctx = messages
