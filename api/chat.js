...
const IMAGE_INSTRUCTION =
  ...
  "EXAMPLE OUTPUT: [[IMAGE]] just for you 😘 ||| Generate image of her taking a mirror selfie, slight side angle, wearing an oversized cream knit sweater and soft shorts, one hand holding the phone up to the mirror and the other resting on her hip, relaxed soft smile with lips slightly parted, in a cozy modern bedroom, warm string lights and a neatly made bed with linen sheets in the background, soft warm evening light with a gentle ambient glow, photorealistic authentic iPhone snap for lover, natural daylight tones, soft highlights, realistic skin texture with visible pores.\n" +
